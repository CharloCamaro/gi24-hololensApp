...
public class sessionController : MonoBehaviour
{
    ...
    public void LaunchSession()
    {
        ...
        stimulusManager.GetComponent<stimulusControllerDouble>().UpdateDataSource();

        stimulusManager.GetComponent<stimulusControllerDouble>().UpdateColorSource();
    ...
    void DistributeSettings()
    {
        ...
        stimulusManager.GetComponent<stimulusControllerDouble>().UpdateParameterValues();        
    }
}
